...
public class UVCCameraHelper {
    ...
    public void initUSB(Context activity, CameraViewInterface cameraView){

    }

    public void initUSBMonitor(Context activity, CameraViewInterface cameraView, final OnMyDevConnectListener listener) {
